...
%% Step 1a Make sure matnwb is ON YOUR PATH

%% Step 1b Make sure seegBRAINplot_s is ON YOUR PATH

%% Step 1c Make sure seegBRAINplot_s/osort-v4-rel is ON YOUR PATH (all sub-folders)

%% Step 2 Create a new folder for spike sorting a session
% i.e., C:/Documents/Data/Study1/SpikeSorting/Session1

%% Step 3 Inside folder NEW Create an 'nwb' folder
...
basepath = 'C:\Users\Admin\Desktop\testfold\';
patientID = 'MW_1';
